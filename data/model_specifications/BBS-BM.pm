...
const demand_d=800; const demand_e=900; const demand_f=1000;
const util_a=30; const util_b=48; const util_c=59; 	  	//new utilization after request is added
const util_d=73; const util_e=85; const util_f=95; 
...
rewards "under_provision"
	[scale_out] pod<desired_replica :1;
	[scale_in] pod<desired_replica :1;
	[do_not] pod<desired_replica :1;
endrewards
